...
class Delaunay:
    ...
    @staticmethod
    def get_delaunay(self, points: np.array) -> list[Triangle2D]:
        ...
        for new_point in points:
            self._add_point(triangles, Point2D(new_point))
        
        return triangles
    
    def _add_point(self, triangles_list: list[Triangle2D], point: Point2D):
